		...
		<div class="span10">
			...
			<div id="tabs-694325" class="tabbable">
				<ul class="nav nav-tabs">
					...
					<!--<li>
						<a href="#panel-788886" data-toggle="tab">加密狗管理</a>
					</li>-->
				</ul>
				<div class="tab-content">
					...
					<div id="panel-788886" class="tab-pane">
						<form action="index.php?user-center-privatement" method="post" class="form-horizontal">
							<fieldset>
								<legend>{x2;$user['username']}</legend>
								<div class="control-group">
									<label for="usbkby" class="control-label">加密狗ID：</label>
									<div class="controls">
										<input id="usbkby" type="text" name="args[usbkey]" needle="true" value="{x2;$user['usbkey']}" msg="请填写加密狗ID"/>
									</div>
								</div>
								<div class="control-group">
									<div class="controls">
										<button class="btn btn-primary" type="submit">提交</button>
										<input type="hidden" name="modifyusbkey" value="1"/>
										<input type="hidden" name="page" value="{x2;$page}"/>
										{x2;tree:$search,arg,aid}
										<input type="hidden" name="search[{x2;v:key}]" value="{x2;v:arg}"/>
										{x2;endtree}
