...
2、在lib/config.inc.php文件中设置数据库参数，注意都要保存为utf8无bom形式（bom问题可能导致后台验证码不出现，修改方法请看：http://NPKS.net/bbs/?thread-index-fid-2-tid-23.htm）
...
ucenter用户整合请参看论坛帖子：
http://NPKS.net/bbs/?thread-index-fid-1-tid-26.htm